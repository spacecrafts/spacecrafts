 ...
 *
 * Version 2012-03-09 (edited)
 *
 * This code was placed in the public domain by its original author,
 * Stefan Gustavson. You may use it as you see fit, but
 * attribution is appreciated.
 */
public class SimplexOctave { // Simplex noise in 2D

	public static int RANDOMSEED = 0;
	private static int NUMBEROFSWAPS = 400;

	private static Grad grad3[] = { new Grad(1, 1), new Grad(-1, 1),
			new Grad(1, -1), new Grad(-1, -1), new Grad(1, 0),
			new Grad(-1, 0), new Grad(1, 0), new Grad(-1, 0),
